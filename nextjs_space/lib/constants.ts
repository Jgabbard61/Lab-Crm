...
export const TEST_STATUS_OPTIONS = [
  ...
  { value: 'Kit Returned', label: 'Kit Returned', color: 'bg-purple-100 text-purple-800' },
  { value: 'Accessioning', label: 'Accessioning', color: 'bg-yellow-100 text-yellow-800' },
  { value: 'Accepted', label: 'Accepted', color: 'bg-green-100 text-green-800' },
  { value: 'Rejected', label: 'Rejected', color: 'bg-red-100 text-red-800' },
  { value: 'Sent to Lab', label: 'Sent to Lab', color: 'bg-indigo-100 text-indigo-800' },
  { value: 'At Lab', label: 'At Lab', color: 'bg-cyan-100 text-cyan-800' },
  { value: 'Resulted', label: 'Resulted', color: 'bg-teal-100 text-teal-800' },
  { value: 'Ready for Bill', label: 'Ready for Bill', color: 'bg-orange-100 text-orange-800' },
  { value: 'Billed - Pending', label: 'Billed - Pending', color: 'bg-amber-100 text-amber-800' },
  { value: 'Billed - Confirmed', label: 'Billed - Confirmed', color: 'bg-lime-100 text-lime-800' },
